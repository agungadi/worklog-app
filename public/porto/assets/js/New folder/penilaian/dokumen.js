                ...
                function appendToUsrTable(user) {
                    $("#docTable").append(`
                          <tr id="user-${user.id}">
                              ...
                              '<td>${user.filename}</td>
                              '<td align="center">
                                  <a title="Edit" class="btn btn-default btn-icon-only-action rounded-circle btn-editDoc" data-toggle="modal"  data-id="${user.id}" data-target="#editModalDoc">
                                  <span class="btn-inner--icon"><i class="fa fa-edit"></i></span> </a>
                                  <a title="Delete" class="btn btn-danger btn-icon-only-action rounded-circle delete-doc" data-id="${user.id}" href="#">
                                  <span class="btn-inner--icon"><i class="fa fa-trash"></i></span></a>
